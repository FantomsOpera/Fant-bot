...
const app = express();
const prefix = "+";
const token = "YOUR TOKEN HERE :P";

app.get("/", (req, res) => {
  res.json({ message: "Fant-bot is running :]" });
});
...
client.on('message', async msg => {
  ...
  switch (command) {
    ...
    case "rarity":
      ...
      msg.channel.send("Your rarity is: `" + rarity.toFixed(2) + "`. Remember; the lower the better!");
      break;
    case "help":
